...
Идея следующая: каждый высказывающийся вначале немного описывает тему, а потом начиает рассуждения, поэтому пусть начало каждого текста
является non argumentative, а оставшаяся часть argumentative.

По сути в корпусе ни claim, ни evidence, а какое-то среднее понятие "аргументативного предложения", что и отмечается в следующей статье.
...
# Небольшой итог
Работы расположены в хронологическом порядке, видно как развивалась терминология и постановка задачи. Нужно обсудить, что же интересно нам.
Содержится несколько интересных способов создания корпусов: абсолютно бесплатный способ получить weak labeled дата и более затратный подход с active learning. Ну и, конечно же, все эти корпуса в том или ином виде подходят под нашу задачу crosslingual transfer. Просто нужно понять, что мы хотим сделать.

Еще я выбрал cloud service, но пока рано жечь деньги.
